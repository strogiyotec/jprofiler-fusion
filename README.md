...
The analog to Telemetries in FusionReactor is the **Metrics** tab that also covers web based metrics. Live memory - real time memory allocated by each object in the heap
